        ...
        <>
            ...
            <div className='container'>
                ...
                <div className='SummaryContainer' >
                    <div className='logo'>
                        <img className="logoImg" src={SimplifyrLogo} />
                    </div>
                <div className="description">
                    ...
                    <button className='btn' onClick={SummaryRedirect} >Try It <img className='arrow' src={arrow} /> </button>
                </div>
                ...
                <div className='ImageContainer' >
                    <div className='logo'>
                        <img className="logoImg" src={NeuralSketchLogo} />
                    </div>
                    <div className="description">
                        ...
                        <button className='btn imgBtn' onClick={imageGenRedirect}>Try It  <img className='arrow' src={arrow} />  </button>
                </div>
                <Header/>
            </div>
        </>
